                ...
                <div class="ibox-content">
                    <form class="m-t" role="form" action="index.html">
                        <div class="col-md-12" style="padding: 0px;">
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="masukkan nama pengguna" class="form-control" id="nama_pengguna">
                            </div>
                    ...
                    <div class="col-md-12" style="margin-top: 40px; background: #2f4050; padding: 10px; border-radius: 5px;">
                        <p class="text-center" style="color: #ecf0f1;">
                            <small>Belum Menggunakan Akoontan ??</small>
                        </p>
