      ...
      <div id="datatable-vue" class="row" style="padding: 0px; margin-top: 10px;">
          ...
          <div class="col-md-12 table-wrapper" style="margin-top: 15px;">
            <table class="table table-bordered table-stripped" style="margin-bottom: 0px;">
                <thead>
                    <tr>
                      <th v-if="config.addition && config.addition.columnNumber && config.addition.columnNumber.show" :width="config.addition.columnNumber.width">No</th>
                      <th v-for="(data, index) in config.feeder.column" :style="data.style" @click="sortMe(data.conteks)">
                        {{ data.text }} &nbsp;
                      ...
                      <th v-if="config.addition && config.addition.columnButton && config.addition.columnButton.show" :width="config.addition.columnButton.width">Aksi</th>
                    </tr>
                </thead>
          ...
          <div class="col-md-12 bottom-wrap">
            ...
            <div class="col-md-6" style="padding: 10px 15px 0px 0px; text-align: right">
              <div class="btn-group" role="group" aria-label="...">
                <button type="button" class="btn btn-default btn-xs" :disabled="page == 1" @click="pageDecrease">Sebelumnya</button>
                <button type="button" class="btn btn-default btn-xs" :disabled="page == fullPage" @click="pageIncrease">Selanjutnya</button>
              </div>
            </div>
          </div>
      </div>
